...
const NavBar = () => {
  ...
  return (
    ...
    <div className={`col-start-1 col-end-8 bg-[#07364B] flex`}>
      ...
      {user.user ?
        <span className={`my-auto ml-auto mr-4 hover:cursor-pointer group`}>
          ...
          <p className={` text-sm inline text-white`}> My Account </p>
          ...
          <span className={`hidden ml-[-50px] z-50 group-hover:grid bg-[#07364B] absolute grid-cols-[200px] border-t-[2px] border-[#0097A7] `}>

            <span onClick={() => {
              router.push('/my-account')
            }} className={`hover:bg-[#102C3A] p-4 `}>
              <p className={` whitespace-nowrap text-sm	text-white `}>  My Profile </p>
            </span>

            <span onClick={() => {
              SignOut()
            }} className={`hover:bg-[#102C3A] p-4 flex`}>
              <p className={` whitespace-nowrap text-sm	text-white`}>  Logout </p>
            </span>
